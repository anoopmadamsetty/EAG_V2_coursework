        ...
        async with stdio_client(server_params) as (read, write):
            ...
            async with ClientSession(read, write) as session:
                ...
                system_prompt = f"""You are a math agent solving problems in iterations. You have access to various mathematical tools.
                    ...
                    - You can use Preview tools (open_preview, draw_rectangle, add_text_in_preview) to visualize results

                    Examples:
                    - FUNCTION_CALL: add|5|3
                    - FUNCTION_CALL: strings_to_chars_to_int|INDIA
                    - FUNCTION_CALL: open_preview
                    - FUNCTION_CALL: draw_rectangle|250|200|550|300
                    - FUNCTION_CALL: add_text_in_preview|Hello World!
                    - FINAL_ANSWER: [42]
